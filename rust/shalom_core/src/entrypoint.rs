...
use crate::{context::{ShalomGlobalContext, SharedShalomGlobalContext}, operation::context::SharedOpCtx, schema::{self, context::SharedSchemaContext}};
...
pub fn parse_document(
    ...
    crate::operation::parse::parse_document(
        global_ctx,
        operation,
        source_path,
    )
